...
def hfh(art_name, performance, stop_event):
    smart_click_image(resource_path("assets", "post", "mj.png"), confidence=0.8, stop_event=stop_event)
    interruptible_sleep(1.5, stop_event)

    mj_path(performance, stop_event)
