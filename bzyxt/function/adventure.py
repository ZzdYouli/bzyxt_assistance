...
def adventure(adventure_name, performance, stop_event, on_finish_callback=None):
    ...
    while not stop_event.is_set():
        ...
        smart_click_image(resource_path("assets", "button", "task.png"), confidence=0.9, stop_event=stop_event)
        ...
        smart_click_image(resource_path("assets", "post", "tjs.png"), confidence=0.9, stop_event=stop_event)
        interruptible_sleep(0.5 * a, stop_event)
        adb_click(445, 1010, stop_event)
        interruptible_sleep(0.5 * a, stop_event)
        ...
        if detect_image(resource_path("assets", "adventure", f"{adventure_switch(adventure_name)}.png", ), confidence=0.9,
